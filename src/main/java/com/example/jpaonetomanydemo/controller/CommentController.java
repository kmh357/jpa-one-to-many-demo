...
public class CommentController {
    ...
    public Comment updateComment(@PathVariable(value = "postId") Long postId, @PathVariable(value = "commentId") Long commentId, @RequestBody Comment commentRequest) {
        ...
        return commentRepository.findById(commentId).map(comment -> {
            ...
            return commentRepository.save(comment);
        }).orElseThrow(() -> new ResourceNotFoundException("CommentId " + postId + " not found"));
    }
